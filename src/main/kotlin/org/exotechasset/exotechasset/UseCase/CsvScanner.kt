...
class CsvScanner(val text:String): AbstractScanner() {
    private val splittedStrList:List<String> = text.split("\n")
    ...
    private var subListIterator = splittedStrListIterator.iterator()
